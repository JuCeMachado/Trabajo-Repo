...
public class InformacionEquipo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbMarca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Positivo BGH", "Samsung", "Asus", "Dell", "Acer", "Brother", "HP", "Lenovo", "Alienware" }));
        ...
        ActualizarPanel.setBackground(new java.awt.Color(0, 208, 163));
        ...
        btnActualizarTxt.setText("Actualizar equipo");
        ...
        ActualizarPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ActualizarPanelLayout.createSequentialGroup()
                ...
                .addComponent(btnActualizarTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        dg_background.add(ActualizarPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 460, 140, 30));
        ...
        dg_background.add(panelRound4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 520, 90, 20));
    ...
    private void btnActualizarTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnActualizarTxtMouseClicked
        ...
        observaciones = jTextPane1.getText();
        ...
        if (observaciones.equals("")) {
            jTextPane1.setText("Sin observaciones");
